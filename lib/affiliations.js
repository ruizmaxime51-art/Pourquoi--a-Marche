...
export const affiliations = {
  ...
  'pichet-pp-hunersdorff-2l': {
    nom: 'Pichet gradué Hünersdorff 2 L en polypropylène',
    descriptif: 'Référence 937000 annoncée de -20 à +100 °C et résistante aux alcalis ; à réserver au savon et à inspecter avant chaque lot',
    reassurance: 'PP · usage dédié · lien affilié Amazon',
    asin: 'B09R4RZYTM',
    url: 'https://www.amazon.fr/dp/B09R4RZYTM?linkCode=ll2&tag=maxscience06-21&linkId=5be3a2ecbe975c73ea1a895d21def171&ref_=as_li_ss_tl',
  },
  balance: {
  ...
  'cristaux-soude': {
    ...
    descriptif: 'Produit ménager de marque connue : suivre le dosage de l\'étiquette sans l\'assimiler automatiquement au décahydrate pur',
    reassurance: 'Vérifier l\'étiquette · lien affilié Amazon',
    asin: 'B0D3DXLC2X',
  ...
  'detachant-sang-proteines-dr-beckmann': {
    nom: 'Dr. Beckmann Diable Détacheur Sang & Protéines — 3 × 50 ml',
    descriptif: 'Détachant enzymatique ciblé pour le prétraitement des taches protéiques ; vérifier les fibres autorisées et suivre la notice',
    reassurance: 'Enzymes · lien affilié Amazon',
    asin: 'B084K3W27H',
    url: 'https://www.amazon.fr/dp/B084K3W27H?linkCode=ll2&tag=maxscience06-21&linkId=760aab3b7f0e881f80a8f5bab54a5771&ref_=as_li_ss_tl',
  },
  ...
  'lunettes-masque-3m-2890a': {
    nom: 'Lunettes-masque 3M GoggleGear 2890A',
    descriptif: 'Oculaire acétate, ventilation indirecte et marquage EN 166 3 4 FT pour les projections liquides',
    reassurance: 'Lien affilié Amazon',
    asin: 'B0B1MGN82Q',
    url: 'https://www.amazon.fr/dp/B0B1MGN82Q?tag=maxscience06-21',
  },
  ...
  'gants-nitrile-jetables': {
    ...
    descriptif: 'Sans poudre et documentés par Saraya pour le contact alimentaire ; adaptés au piment, pas à la soude caustique',
    reassurance: 'Contact alimentaire documenté · lien affilié Amazon',
    asin: 'B0D8NS182Y',
  ...
  'percarbonate-compagnie-2kg': {
    nom: 'Percarbonate de soude Compagnie du Bicarbonate — 2 kg',
    descriptif: 'Formule annoncée sans additif et 100 % à base de percarbonate ; vérifier la notice avant usage',
    reassurance: 'Lien affilié Amazon',
    asin: 'B099PVNJ8Q',
    url: 'https://www.amazon.fr/dp/B099PVNJ8Q?tag=maxscience06-21',
  },
  'testeur-durete-agualeve': {
    nom: 'Testeur de dureté de l’eau AGUALEVE',
    descriptif: 'Pour mesurer l’eau du robinet en degrés français avant d’adapter une lessive au savon',
    reassurance: 'Lien affilié Amazon',
    asin: 'B0CJ9QQ2M2',
    url: 'https://www.amazon.fr/dp/B0CJ9QQ2M2?tag=maxscience06-21',
  },
};
...
export function renderAffiliationBlock(key) {
  ...
  <div class="cta-action">
    <a class="cta-button" href="${a.url}" target="_blank" rel="nofollow sponsored noopener" data-cm-event="affiliate_click" data-cm-target="${key}">Voir la fiche sur Amazon →</a>
...
export function renderAffiliationInline(key) {
  const a = affiliations[key];
  if (!a) return `<!-- affiliation inconnue: ${key} -->`;
  return `<a href="${a.url}" target="_blank" rel="nofollow sponsored noopener" data-cm-event="affiliate_click" data-cm-target="${key}">${a.nom}</a>`;
}
