...
export const affiliations = {
  ...
  'percarbonate-amazon-search': {
    nom: 'Percarbonate de soude : comparer les formats',
    descriptif: 'Vérifiez la composition, les précautions et le dosage de l’étiquette avant de choisir',
    reassurance: 'Lien affilié Amazon',
    url: 'https://www.amazon.fr/s?k=percarbonate+de+soude+pur&tag=maxscience06-21',
  },
};
