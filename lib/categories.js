...
export const categories = {
  cosmetique: {
    ...
    tagline: 'Formuler un savon, comprendre sa texture et choisir le matériel de protection adapté.',
  ...
  conservation: {
    ...
    tagline: 'Choisir les conditions de stockage et comprendre les limites du froid, du sel, du sucre et de la fermentation.',
    formula: 'température · acidité · activité de l’eau',
    kind: 'usage',
  },
  fermentation: {
    slug: 'fermentation',
