...
export const references = {
  ...
  'umn-home-fermentation': {
    ...
    url: 'https://extension.umn.edu/food/preparing/cooking-at-home/food-preservation/fermentation',
  },
  'nchfp-dill-pickles': {
    titre: 'Dill Pickles',
    editeur: 'National Center for Home Food Preservation / University of Georgia',
    note: 'Recette définie de cornichons fermentés : contrôle de la surface et critères de rejet. Ses consignes ne se transposent pas à tous les légumes fermentés.',
    url: 'https://nchfp.uga.edu/how/ferment/recipes/dill-pickles/',
  },
  'kingarthur-starter': {
    titre: 'Sourdough Starter',
    editeur: 'King Arthur Test Kitchen',
    note: 'Protocole pratique de création et d’entretien du levain ; pesées et adaptation à son évolution. Consulté le 10 septembre 2026.',
  ...
  'krencker-crufiture-patent': {
    titre: 'Procédé de préparation d’une conserve de fruits tartinable — FR3022118A1',
    editeur: 'INPI / Google Patents',
    note: 'Brevet de Fabrice Krencker décrivant le mélange fruits-sucre, l’évaporation à température ambiante, le suivi de la masse, une activité de l’eau cible inférieure à 0,80 et plusieurs formulations comportant du fructose ou un acidifiant. Un brevet décrit une invention ; il ne constitue pas à lui seul une validation indépendante de sécurité domestique.',
    url: 'https://patents.google.com/patent/FR3022118A1/fr',
  },
  'iso-2173-soluble-solids': {
    titre: 'ISO 2173:2003 — Détermination des matières solubles par réfractométrie',
    editeur: 'Organisation internationale de normalisation',
    note: 'Méthode réfractométrique pour les produits à base de fruits et légumes. L’ISO précise que d’autres substances dissoutes rendent le résultat approximatif : le degré Brix n’est donc pas une mesure directe de l’activité de l’eau.',
    url: 'https://www.iso.org/standard/35851.html',
  },
  'fda-water-activity-foods': {
    titre: 'Water Activity (aw) in Foods',
    editeur: 'U.S. Food and Drug Administration',
    note: 'Définition de l’activité de l’eau, rôle des ingrédients, de la température et de la mesure à l’équilibre. La maîtrise de l’aw doit être reliée à une formulation documentée et ne signifie pas que le produit a été stérilisé.',
  ...
  'marvig-zygosaccharomyces-rouxii': {
    titre: 'Growth/no growth models for Zygosaccharomyces rouxii associated with acidic, sweet intermediate moisture food products',
    editeur: 'International Journal of Food Microbiology / PubMed',
    note: 'Modèles de croissance d’une levure osmophile dans des aliments sucrés acides, étudiés entre aw 0,65 et 0,80 et pH 2,5 à 4,0. L’étude montre que certaines levures d’altération tolèrent des milieux très sucrés et acides. DOI : 10.1016/j.ijfoodmicro.2014.09.021.',
    url: 'https://pubmed.ncbi.nlm.nih.gov/25306299/',
  },
  'bourdoux-drying-microbial-safety': {
    titre: 'Performance of Drying Technologies to Ensure Microbial Safety of Dried Fruits and Vegetables',
    editeur: 'Comprehensive Reviews in Food Science and Food Safety / PubMed',
    note: 'Revue rappelant qu’un aliment à faible activité de l’eau peut encore permettre la survie de microorganismes et que l’inactivation microbienne par séchage, y compris solaire, reste distincte de la simple réduction de l’aw. DOI : 10.1111/1541-4337.12224.',
    url: 'https://pubmed.ncbi.nlm.nih.gov/33401832/',
  },
  'nchfp-uncooked-jam': {
    titre: 'Berry Jam (Uncooked)',
    editeur: 'National Center for Home Food Preservation / University of Georgia',
    note: 'Recette institutionnelle de confiture non cuite conservée au réfrigérateur ou au congélateur. Elle illustre que « sans cuisson » ne signifie pas automatiquement « stable à température ambiante ».',
    url: 'https://nchfp.uga.edu/how/make-jam-jelly/jams/berry-jam-uncooked/',
  },
