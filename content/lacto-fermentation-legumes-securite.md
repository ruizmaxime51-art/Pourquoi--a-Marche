---
title: "Lacto-fermentation des légumes : pourquoi c'est sûr (si on respecte deux règles)"
...
<ul>
<li><a href="#mat-bocal">Bocal à valve de fermentation</a> — laisse échapper le CO₂ sans laisser entrer l'air</li>
...
<h4>La théorie : trois phases, trois populations</h4>
<p>La lacto-fermentation ne se fait pas en un seul mouvement mais en trois phases, portées par
des micro-organismes différents qui se relaient.</p>
<p><strong>Phase 1 (jours 1-2)</strong> : les bactéries opportunistes déjà présentes sur le
légume (entérobactéries notamment) démarrent une activité modérée, quelques bulles apparaissent.</p>
<p><strong>Phase 2 (jours 2-4)</strong> : <em>Leuconostoc mesenteroides</em> devient dominante —
elle produit du CO₂ (d'où les bulles plus marquées) et un peu d'acide, ce qui commence à faire
baisser le pH et crée un milieu anaérobie favorable à la suite.</p>
<p><strong>Phase 3 (jour 4 et après)</strong> : <em>Lactobacillus plantarum</em> prend le relais
et devient largement dominante — c'est elle qui produit la majorité de l'acide lactique, fait
chuter le pH jusqu'à 3,5-4, et élimine la compétition par son acido-tolérance supérieure. Ce pH
acide inhibe la croissance des bactéries pathogènes, notamment <em>Clostridium botulinum</em>,
responsable du botulisme — c'est ce mécanisme, et non le sel seul, qui rend le produit sûr.</p>
</div>

**Pourquoi le sel a précisément ce rôle**

Le sel à 2-3% n'est pas qu'un exhausteur de goût : il joue un rôle de **sélection biologique**.
Cette concentration inhibe davantage les bactéries de putréfaction (moins tolérantes au sel) que
les bactéries lactiques (naturellement plus résistantes), ce qui donne un avantage compétitif
aux bonnes bactéries dès le départ — avant même que l'acidité ne prenne le relais comme barrière
de sécurité.

## Les deux paramètres qui font toute la sécurité

**Le taux de sel** : entre 2 et 3 % du poids total (légumes + eau). En dessous, les bactéries
indésirables ne sont pas suffisamment inhibées au démarrage de la fermentation. Au-dessus de 5 %,
les bactéries lactiques elles-mêmes sont ralenties.

**L'anaérobiose** : les légumes doivent rester immergés sous la saumure en permanence. Toute
partie émergée expose le produit à l'air et donc à des moisissures de surface — ce n'est pas
...
Trois facteurs expliquent pourquoi un légume se prête bien ou mal à la lacto-fermentation : sa
teneur en sucres naturels (nourriture des bactéries), sa texture (les légumes fermes tiennent
mieux en immersion prolongée que les légumes tendres qui ramollissent), et sa flore bactérienne
naturelle (les légumes racines, en contact avec la terre, portent naturellement plus de
bactéries lactiques que des légumes très lavés).

**La vraie règle qui détermine la méthode n'est pas le type de légume, c'est la découpe.** Ce
qui compte, c'est la surface de contact entre le sel et le légume. Un légume râpé ou finement
émincé (comme le chou pour la choucroute, ou une carotte râpée) a une surface énorme exposée au
sel — il relâche donc assez de jus pour s'auto-saumurer, sans eau ajoutée : environ 10g de sel
par kilo de légume râpé suffit. Le même légume coupé en bâtonnets épais ou laissé entier (comme
dans la recette plus bas) a une surface bien plus réduite — il ne relâchera jamais assez de jus
tout seul, d'où la saumure externe à 2-3% nécessaire.
...
6. Goûter à partir du 5e jour : plus l'acidité est prononcée, plus la fermentation est avancée. Passer au réfrigérateur une fois le goût souhaité atteint.

## Le matériel, en détail

<div class="cta-block" id="mat-bocal">
<div class="cta-text"><strong>Bocal de fermentation 1L, valve automatique</strong><span>Diesisa — CO₂ évacué sans laisser entrer l'air, graduations précises</span></div>
<div class="cta-action">
<a class="cta-button" href="https://www.amazon.fr/Diesisa-Borosilicat%C3%A9-Bocal-Fermentation-A%C3%A9rations/dp/B0H158V3C4?linkCode=ll2&tag=maxscience06-21&linkId=1e8f018d1187e889a0ce712844a8104c&ref_=as_li_ss_tl" rel="sponsored noopener" target="_blank">Voir le prix →</a>
<span class="cta-reassurance">Expédié par Amazon</span>
</div>
</div>

<div class="cta-block" id="mat-poids">
<div class="cta-text"><strong>Poids de fermentation en verre, 7cm</strong><span>Okllen — maintient les légumes immergés</span></div>
<div class="cta-action">
<a class="cta-button" href="https://www.amazon.fr/Okllen-fermentation-ouverture-ramassage-lave-vaisselle/dp/B0BLTKGTPH?linkCode=ll2&tag=maxscience06-21&linkId=00ed55f78e9da4cb3823fc9f6d9e08d7&ref_=as_li_ss_tl" rel="sponsored noopener" target="_blank">Voir le prix →</a>
<span class="cta-reassurance">Expédié par Amazon</span>
</div>
</div>

<div class="cta-block" id="mat-balance">
<div class="cta-text"><strong>Balance de précision 0,1g / 5kg</strong><span>La même que pour les autres articles — inox, étanche</span></div>
<div class="cta-action">
